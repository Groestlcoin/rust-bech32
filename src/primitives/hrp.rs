...
// Defines HRP constants for the different groestlcoin networks.
// You can also access these at `crate::hrp::GRS` etc.
#[rustfmt::skip]
...
define_hrp_const! {
    /// The human-readable part used by the Groestlcoin mainnet network.
    pub const GRS 3 [103, 114, 115, 0, 0];
}
define_hrp_const! {
    /// The human-readable part used by the Groestlcoin testnet networks (testnet, signet).
    pub const TGRS 4 [116, 103, 114, 115, 0];
}
define_hrp_const! {
    /// The human-readable part used when running a Groestlcoin regtest network.
    pub const GRSRT 5 [103, 114, 115, 114, 116];
}
